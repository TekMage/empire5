...
// All 34 sector types in uid order (matching 4.4.1 sect.config).
const SECT_TYPES: &[SectorType] = &[
    SectorType::Sea,
    SectorType::Mountain,
    SectorType::Sanctuary,
    SectorType::Wasteland,
    SectorType::Wilderness,
    SectorType::Capital,
    SectorType::UraniumMine,
    SectorType::Park,
    SectorType::DefensePlant,
    SectorType::ShellIndus,
    SectorType::Mine,
    SectorType::GoldMine,
    SectorType::Harbor,
    ...
    SectorType::Agri,
    SectorType::OilField,
    SectorType::LightManuf,
    SectorType::HeavyManuf,
    SectorType::Fortress,
    SectorType::TechCenter,
    SectorType::ResearchLab,
    SectorType::NuclearPlant,
    SectorType::Library,
    SectorType::Highway,
    SectorType::Radar,
